...
def set_cube_blue():
    """Mission Cube의 기존 Red texture를 제거하고 파란색으로 만든다."""
    ...
    if tint_attr.IsValid():
        tint_attr.Set(Gf.Vec3f(1.0, 1.0, 1.0))

    print("   cube color   BLUE")
...
def main():
    ...
    # 이번 Mission에서 사용할 Pick 위치를 한 번 결정
    pick_xy = sample_pick_xy()

    set_cube_blue()

    # 실제 Cube와 FSM이 같은 좌표를 사용하도록 한다
